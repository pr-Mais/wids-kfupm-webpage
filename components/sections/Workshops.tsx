  ...
  return (
    <section id="workshops" className="py-20 px-6 bg-[#161E26] text-white">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-emerald-400 mb-2 font-mono">
          <span className="text-white">$ </span>
          {displayText}
          <span
            className={`inline-block w-2 h-6 bg-emerald-400 ml-1 ${
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {workshops.map((workshop, index) => (
            <div
              key={index}
              className="bg-gray-800 rounded-lg overflow-hidden border border-gray-700 hover:border-emerald-400 transition-all group"
            >
              <div className="p-6">
                ...
                <Link
                  ...
                  className="inline-block bg-emerald-600 hover:bg-emerald-500 text-white font-mono font-medium py-2 px-6 rounded-md transition-colors border border-emerald-400 group-hover:bg-emerald-700"
                >
                  JOIN THE WORKSHOP
                </Link>
              </div>
              ...
              <div className="bg-gray-900 px-6 py-3 text-xs text-gray-500 font-mono">
                <span className="text-emerald-400">//</span> workshop_
                {index + 1}.component
              </div>
            </div>
          ))}
