...
const benefits = [
  {
    icon: <FaMicroblog className="text-2xl text-teal-600" />,
  ...
  {
    icon: <FaLaughSquint className="text-2xl text-teal-600" />,
          ...
          {benefits.map((benefit, index) => (
            ...
            >
              <div className="relative">
                ...
                <div className="absolute -top-8 -right-2 w-8 h-8 bg-teal-600 text-white rounded-full flex items-center justify-center font-mono text-sm font-bold">
                  {benefit.number}
                </div>

                <div className="flex items-start gap-4">
                  {/* Icon with gradient background */}
                  <div className="flex-shrink-0 p-3 bg-gradient-to-br from-teal-100 to-green-100 rounded-lg">
                    {benefit.icon}
                  </div>
                  <div>
