      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-12 items-top">
          ...
          <div className="relative w-full lg:w-1/2">
            <div className="relative aspect-[4/3] overflow-hidden rounded-xl border-1 border-emerald-400">
              <Image
                src={imageSrc}
                alt={imageAlt}
                fill
            ...
            <div className="absolute -z-10 -bottom-4 -right-4 w-full h-full border-2 border-emerald-400 rounded-xl"></div>
          </div>
